...
const show1 = ()=>{
    ...
    ;
        ...
        let nigeria = new country("Nigeria", nigeriaFlag, nigeriaNote)
        obj = nigeria
    ...
    const show2 = ()=>{
      ...
      let Switzerland = new country("Switzerland", SwitzerlandFlag, SwitzerlandNote)
      obj = Switzerland
  ...
  const show3 = ()=>{
        ...
        let Canada = new country("Canada", CanadaFlag, CanadaNote)
        obj = Canada
    ...
    const show4 = ()=>{
        ...
        let Japan = new country("Japan", JapanFlag, JapanNote)
        obj = Japan
        Japan.returnContent()
    }
    const show5 = ()=>{
      ...
      let South_Africa = new country("South_Africa", South_AfricaFlag, South_AfricaNote)
      obj = South_Africa
  ...
  const show6 = ()=>{
    ...
    let Madagascar = new country("Madagascar", MadagascarFlag, MadagascarNote)
    obj = Madagascar
...
const show7 = ()=>{
  ...
  let Italy = new country("Italy", ItalyFlag, ItalyNote)
  obj = Italy
  Italy.returnContent()
}
const show8 = ()=>{
  ...
  let Greece = new country("Greece", GreeceFlag, GreeceNote)
  obj = Greece
...
const show9 = ()=>{
  ...
  let Ethiopia = new country("Ethiopia", EthiopiaFlag, EthiopiaNote)
  obj = Ethiopia
...
const show10 = ()=>{
  ...
  let Spain = new country("Spain", SpainFlag, SpainNote)
  obj = Spain
  Spain.returnContent()
}
const show11 = ()=>{
  ...
  let Argentina = new country("Argentina", ArgentinaFlag, ArgentinaNote)
  obj = Argentina
...
const show12 = ()=>{
  ...
  let Algeria = new country("Algeria", AlgeriaFlag, AlgeriaNote)
  obj = Algeria
...
const show13 = ()=>{
  ...
  let Rwanda = new country("Rwanda", RwandaFlag, RwandaNote)
  obj = Rwanda
...
const show14 = ()=>{
  ...
  let Ireland = new country("Ireland", IrelandFlag, IrelandNote)
  obj = Ireland
...
const show15 = ()=>{
  ...
  let Austria = new country("Austria", AustriaFlag, AustriaNote)
  obj = Austria
...
const show16 = ()=>{
  ...
  let New_Zealand = new country("New_Zealand", New_ZealandFlag, New_ZealandNote)
  obj = New_Zealand
...
const show17 = ()=>{
  ...
  let Isreal = new country("Isreal", IsrealFlag, IsrealNote)
  obj = Isreal
...
const show18 = ()=>{
  ...
  let France = new country("France", FranceFlag, FranceNote)
  obj = France
...
const show19 = ()=>{
  ...
  let Brazil = new country("Brazil", BrazilFlag, BrazilNote)
  obj = Brazil
...
const show20 = ()=>{
  ...
  let Mali = new country("Mali", MaliFlag, MaliNote)
  obj = Mali
  Mali.returnContent()
}
const show21 = ()=>{
  ...
  let Costa_Rica = new country("Costa_Rica", Costa_RicaFlag, Costa_RicaNote)
  obj = Costa_Rica
